...
from utility.utility import check_directory
...
class AbstractAlgorithm(abc.ABC):
    ...
    def plot_data(self, dataset, dataset_mode, y_test):
        dataset_name = dataset.get_name()
        file_path = ROOTPATH + "Results/" + dataset_mode + "/" + self.get_name() + "/" + dataset_name + "/plots/"
